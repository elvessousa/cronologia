...
if ( !function_exists('ess_create_timeline') ) {
    ...
    function ess_create_timeline() {
        ...
        $capabilities = array(
            'edit_post'           => 'edit_special',
            'read_post'           => 'read_special',
            'delete_post'         => 'delete_special',
    ...
    function ess_timeline_columns_display($timeline_columns){
        ...
        switch ($timeline_columns) {
            ...
            break;
            case 'chronologies':
            echo get_the_term_list($post->ID, 'chronologies', '<li style="list-style: none; margin: 0">', '</li><li style="list-style: none; margin: 0">','</li>');
            break;
        }
    }
