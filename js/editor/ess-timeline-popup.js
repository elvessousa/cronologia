...
(function() {
	tinymce.create('tinymce.plugins.essCPTButtons', {
		init : function(ed, url) {
			...
			// Timeline
			// ----------------------------------------------------
			ed.addCommand('timeline-popup', function() {
				ed.windowManager.open({
					file : url + '/popups/timeline-popup.php',
					width : 420,
					height : 310,
					inline : 1
				}, {
			...
			ed.addButton('timeline', {title : 'Timeline', cmd : 'timeline-popup', image: url + '/icons/timeline.png' });
